...
| 10 | **The dry river.** The map ships dry and the scene plays at tick 0, so the river and Sump shots show empty beds. Water arrives fast: the Sump stood at 0.5 by day 1, 41 %. | the author's decision (human) | blocked: asked |
