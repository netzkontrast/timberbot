...
- **Chapter unlock service shipped** (`WardensChapterService`, `wardens/src/WardensChapters.cs`): nine
  ...
  *2026-09-11: the padlocks are gone. Every building ships at `ScienceCost: 0` and is buildable from the
  first frame of every level; the chapters stay as story beats (toast, Uplink line, cutscene). See
  `wardens-chapter-1-plan.md`, status 2026-09-11.*
- **The wasteland map shipped** (`wardens/src/Maps/Wardens 01 First Light.timber`, generated by
